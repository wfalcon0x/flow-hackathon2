...
const OtpField = ({
    ...
    return (
        <div className={cn(classNames, { 'otp-field--has-error': hasError })} {...props}>
            {values.map((element, index) => (
                <div key={index} className='flex justify-between'>
                    <Input 
                        className='otpFieldInput rounded-xl gradient-border-focus focus:border-none hover:border-gray-300 bg-gray-100 border-gray-200 mb-3'
