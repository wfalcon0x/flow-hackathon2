...
export default function Header() {
  ...
  return (
    <header className={`[background:linear-gradient(90.19deg,_#eb98fd,_#6ab7ff)] rounded-2xl fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-white backdrop-blur-sm shadow-lg' : ''}`}>
