  ...
  return (
    <>  
      ...
      <div className="absolute bottom-3 flex justify-between w-full px-3">
        <Button className="text-primary border-none font-bold" onClick={() => handlePrev()}>Back</Button>
        <Button className="gradient text-white font-bold rounded-full flex gap-2 items-center p-5" onClick={() => handleNext()}>
          Next
